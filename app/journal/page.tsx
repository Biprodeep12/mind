...
import { Calendar, Edit, Plus, Search, Heart } from "lucide-react";
  ...
  const journalEntries = [
    {
      ...
      excerpt:
        "Today was much better than yesterday. I managed to get out of bed early and...",
      date: "Mar 15, 2025",
      mood: "Good",
    ...
    },
    {
      ...
      excerpt:
        "My session with Dr. Smith was really insightful today. We discussed...",
      date: "Mar 13, 2025",
      mood: "Neutral",
    ...
    },
    {
      ...
      excerpt:
        "Finding it hard to get motivated today. Everything feels like an uphill battle...",
      date: "Mar 10, 2025",
      mood: "Low",
    ...
    },
    {
      ...
      excerpt:
        "Looking forward to meeting up with Alex and Jordan this weekend. It's been a while...",
      date: "Mar 8, 2025",
      mood: "Good",
      tags: ["social", "plans"],
    },
